...
const COMMANDS: Record<string, () => string[]> = {
  ...
  experience: () => [
    '<span class="text-cyan-400">► Associate DevOps Engineer</span>  <span class="text-slate-500">May 2026 – Present</span>',
    '  Behaviol Pty Ltd',
    '',
    '<span class="text-cyan-400">► Intern DevOps Engineer</span>  <span class="text-slate-500">Nov 2025 – May 2026</span>',
    '  Behaviol Pty Ltd',
